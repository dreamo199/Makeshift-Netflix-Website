      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-10 p-10 max-w-6xl mx-auto">
        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <button className="bg-white/20 border border-white/30 px-6 py-3 rounded-lg font-semibold hover:bg-white/30 transition">
              + Add to My List
            </button>
          </div>
            <div>
            <div className="sticky top-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {similar.map((i, index) => (
                  <Link to={`/movies/${i.id}/`} style={{ textDecoration: "none", color: "inherit" }}>
